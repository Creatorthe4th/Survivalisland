...
1. Download the ZIP and extract it. Replace the main project folder with the internal folder and its contents.
2. In Unity Hub, choose **Add → Add project from disk** and select the project folder. Open it with Unity version **6000.0.77f1**.
3. In the Project window, open the **Scenes** folder and open the **SampleScene** scene.
4. Once the scene finishes loading, press **Play** to start a run — the game drops you straight into gameplay (no main menu).
